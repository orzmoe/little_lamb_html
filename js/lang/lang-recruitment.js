const ids = [
 ...
 ,'linkId','indexsId','recruitmentsId',
 'works1Id','works1P1Id','works1P2Id','works1P3Id','works1P4Id',
 'works2Id','works2P1Id','works2P2Id','works2P3Id','works2P4Id',
 'works3Id','works3P1Id','works3P2Id','works3P3Id','works3P4Id',
 'works4Id','works4P1Id','works4P2Id','works4P3Id','works4P4Id',
];
var zh = [
 '首页','外卖','活动','招聘','联系我们','您的位置:','首页','招聘',
 '服务员','暂不缺人','待遇面议','工作地点','申请资格仅限新加坡公民，永久居民、家属证和长期居留证持有者',
 '厨房助理','暂不缺人','待遇面议','工作地点','申请资格仅限新加坡公民，永久居民、家属证和长期居留证持有者',
 '厨师','暂不缺人','待遇面议','工作地点','申请资格仅限新加坡公民，永久居民、家属证和长期居留证持有者',
...
var en = [
 ...
 'Dishwasher','Temporarily No Recruitment','Negotiable Treatment','Work Location','Eligibility for application is limited to Singapore Citizen, Permanent Residents, Dependant Pass and Long-Term Visit Pass holders.',
 ]; 
